...
document.addEventListener("DOMContentLoaded", function () {
  (function ($) {
    // phone mask
    $('input[name=phone]').mask('+380 00 000 00 00'); // works-slider
    ...
    $('.owl-carousel').owlCarousel({
      ...
      dots: false,
      items: 1,
      navText: ['<img class="mob" src="../img/_src/arr_left_mob.svg" alt="arr-left"><img class="desc" src="../img/_src/arr_left.svg" alt="arr-left">', '<img class="mob" src="../img/_src/arr_right_mob.svg" alt="arr-right"><img class="desc" src="../img/_src/arr_right.svg" alt="arr-right">'],
      responsive: {
        1200: {
          items: 2
        },
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/scripts.min.js");
/******/ 	
/******/ })()
;